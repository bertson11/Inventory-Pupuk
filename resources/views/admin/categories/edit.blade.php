...
<head>
    ...
    <title>Edit Kategori - Asian Agri Inventory</title>
    ...
    <div class="container mx-auto px-4 py-8">
        ...
        <div class="mb-8">
            ...
            <p class="text-gray-600 mt-1">
                {{ now()->format('l, d F Y') }} | 
                <span class="text-[#1E3A2E] font-semibold">Perbarui informasi kategori</span>
            </p>
        </div>
                    ...
                    <div class="space-y-6">
                        ...
                        <div>
                            ...
                            <textarea name="description" 
                                      rows="4"
                                      class="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-1 focus:ring-[#1E3A2E] focus:border-[#1E3A2E]">{{ old('description', $category->description) }}</textarea>
                            @error('description')
                                <p class="text-red-500 text-xs mt-1">{{ $message }}</p>
                            @enderror
                        </div>
                                ...
                                <div class="flex items-start">
                                    ...
                                    <div>
                                        <p class="text-sm text-blue-700">
                                            <span class="font-bold">{{ $productsCount }} produk</span> menggunakan kategori ini. 
                                            Perubahan akan mempengaruhi produk-produk tersebut.
                                        </p>
                                    </div>
                                </div>
                            </div>
