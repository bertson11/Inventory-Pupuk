...
<head>
    ...
    <title>Tambah Supplier - Asian Agri Inventory</title>
    ...
    <div class="container mx-auto px-4 py-8">
        ...
        <div class="mb-8">
            ...
            <p class="text-gray-600 mt-1">
                {{ now()->format('l, d F Y') }} | 
                <span class="text-[#1E3A2E] font-semibold">Input data supplier/pemasok pupuk</span>
            </p>
        </div>
        ...
        <div class="bg-white rounded-lg shadow-md overflow-hidden">
            <div class="px-6 py-4 border-b border-gray-200">
                <h3 class="font-semibold text-gray-800">
                    <i class="fa-solid fa-truck text-[#1E3A2E] mr-2"></i>
                    Form Input Supplier
                </h3>
            </div>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div class="md:col-span-2">
                            ...
                            <input type="text" 
                                   name="name" 
                                   value="{{ old('name') }}"
                                   placeholder="Contoh: PT Pupuk Indonesia, Petrokimia Gresik, dll"
                        ...
                        <div class="md:col-span-2">
                            ...
                            <textarea name="address" 
                                      ...
                                      class="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-1 focus:ring-[#1E3A2E] focus:border-[#1E3A2E]">{{ old('address') }}</textarea>
                            @error('address')
                                <p class="text-red-500 text-xs mt-1">{{ $message }}</p>
                            @enderror
                        </div>
                        ...
                        <div class="flex items-start">
                            ...
                            <div>
                                <p class="text-sm text-green-700">
                                    Supplier akan digunakan untuk mencatat asal barang pada transaksi stok masuk.
                                    Contoh supplier: PT Pupuk Indonesia, Petrokimia Gresik, Koperasi Tani, dll.
                                </p>
                            </div>
                        </div>
                    </div>
