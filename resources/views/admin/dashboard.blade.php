...
<body class="bg-gray-50">
        ...
        <div class="container mx-auto px-4">
            <div class="flex justify-between items-center h-16">
                <div class="flex items-center space-x-2">
                    <img src="{{ asset('images/logo-asian-agri.png') }}" alt="Logo" class="h-20 w-auto">  <!-- ← LOGO GAMBAR -->
    ...
    <script>
        ...
        // Fungsi untuk mulai realtime updates
        ...
        function updateStats(data) {
            ...
            $('#stok-masuk').text(formatNumber(data.stokMasukHariIni));
            $('#stok-keluar').text(formatNumber(data.stokKeluarHariIni));
            $('#stok-menipis').text(data.stokMenipis);
            $('#pending-count').text(data.pendingApproval);
        }

        // Fungsi untuk highlight cards yang diupdate
        function highlightUpdatedCards() {
            $('.stat-card').addClass('highlight');
            setTimeout(function() {
                $('.stat-card').removeClass('highlight');
            }, 500);
        }
        ...
        function refreshData() {
            ...
            Swal.fire({
                ...
                text: 'Data statistik berhasil diperbarui',
                timer: 1500,
        ...
        function showAddStockModal(productId, productName) {
            ...
            $('#modalTitle').text('Tambah Stok - ' + productName);
            $('#addStockModal').removeClass('hidden').addClass('flex');
        }

        // Fungsi untuk menutup modal
        function closeModal() {
            $('#addStockModal').removeClass('flex').addClass('hidden');
            $('#addStockForm')[0].reset();
        }

        // Fungsi untuk menambah stok via AJAX
        function addStock() {
            ...
            $.ajax({
                url: '/admin/transactions/stock-in',
                method: 'POST',
                data: {
                    _token: '{{ csrf_token() }}',
